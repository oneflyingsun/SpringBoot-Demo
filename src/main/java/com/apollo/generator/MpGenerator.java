...
public class MpGenerator {
     ...
     * </p>
     */
    public static void generate(GeneratorParam param, String packageParent, String moduleName) {
...
//        strategy.setTablePrefix(new String[] { ""});// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
         strategy.setInclude(new String[] { param.getTableName() }); // 需要生成的表，不指定会生成所有的表
...
//        cfg.setFileOutConfigList(focList);
    ...
    public static void main(String[] args) {
        ...
        param.setUrl("jdbc:mysql://localhost:3306/shiro_demo?useUnicode=true&characterEncoding=UTF-8&useSSL=false")
                .setUserName("root")
                .setPath(path)
                .setTableName("test1")
                .setPassword("12345678")
                .setAuthor("apollo");
        generate(param, "com.apollo.modules", "test1");
    }
}